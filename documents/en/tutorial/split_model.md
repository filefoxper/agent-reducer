...
You can check code in [splitModel.spec.ts](https://github.com/filefoxper/agent-reducer/blob/master/test/en/tutorial/splitModel.spec.ts).

```typescript
import {createAgentReducer, middleWare, MiddleWarePresets, OriginAgent} from "agent-reducer";
...
Ok, at this time, our model can work well, let us add more things to make the models much better. [See next section](https://github.com/filefoxper/agent-reducer/blob/master/documents/en/tutorial/take_latest.md).