...
You can check code in [takeLatest.middleWare.spec.ts](https://github.com/filefoxper/agent-reducer/blob/master/test/en/tutorial/takeLatest.middleWare.spec.ts).

```typescript
iimport {createAgentReducer, middleWare, MiddleWarePresets, OriginAgent, useMiddleWare} from "agent-reducer";
...
```
If you want to take debounce feature when changing `currentPage`, please see [next section](https://github.com/filefoxper/agent-reducer/blob/master/documents/en/tutorial/complex.md)