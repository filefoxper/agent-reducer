...
If you want to know how to optimize the size of `agent-reducer` in your package, please go on, or you can take [Getting started](/introduction?id=getting-started) immediately.
