import {Action, AgentReducer, Dispatch, Env, OriginAgent, Reducer, StoreSlot} from "./reducer.type";
...
export function createAgentReducer<S, T extends OriginAgent<S>>(originAgent: T | { new(): T }, e?: Env): AgentReducer<S, Action, T> {
  ...
  let storeSlot: StoreSlot<S> = {
    ...
    dispatch(action: Action) {
      ...
      entity.state = reducer(this.getState(), action);
    }
  };
